...
> **Beta** — tested with Rekordbox 6/7 on macOS 13+. Please report issues.
...
3. **First launch only:** macOS will warn that the developer is unverified.
   Right-click the app → **Open** → click **Open** in the dialog
4. After the first open, double-click works normally

> The app is ad-hoc signed (no Apple notarization). This is normal for beta software.

---

## How to use

1. **Close Rekordbox** — the app writes directly to the Rekordbox database; it must be closed during import
2. Launch Playlist Converter
3. Connect your Rekordbox USB stick — playlists appear automatically in the left panel
...
The app remembers which USB stick and playlists you last used. When you relaunch with the same USB connected, it auto-selects it and pre-checks the same playlists.
...
- Notarization is not implemented — first-launch Gatekeeper warning is expected
- Tested on Apple Silicon (M-series) Macs; Intel Macs should work but are less tested
